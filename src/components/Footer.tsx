                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
                    ...
                    <div className="space-y-4 text-left">
                        <a href="#home" onClick={(e) => handleScroll(e, '#home')} className="inline-block" aria-label="GasTech Home">
                            <img src="logo.png" alt="GasTech Logo" className="h-24 w-auto" />
                        </a>
                    ...
                    <div className="space-y-4 text-right">
                        ...
                        <ul className="space-y-3 text-blue-200">
                            <li className="flex items-center justify-end">
                                ...
                                <a href="tel:07809763590" className="hover:text-yellow-400">07809 763590</a>
                            </li>
                            <li className="flex items-center justify-end">
                            ...
                            <li className="flex items-center justify-end">
                                ...
                                <a href="mailto:vikram4king@yahoo.com" className="hover:text-yellow-400">vikram4king@yahoo.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
